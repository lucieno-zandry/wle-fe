                    ...
                    <CommandList className="max-h-[450px]">
                        {isLoading && (
                            <div className="flex items-center justify-center py-6 text-sm text-muted-foreground">
                                ...
                                {t('common:findingProducts')}
                            </div>
                        )}

                        {!isLoading && query && products.length === 0 && (
                            <CommandEmpty>{t('common:noResultsFound', { query })}</CommandEmpty>
                        )}
                        ...
                        {!isLoading && products.length > 0 && (
                            <>
                                <div className="border-b px-2 py-2">
                                    ...
                                    >
                                        <span>{t('common:viewAllResults', { count: products.length })}</span>
                                ...
                                {products.length > 5 && (
                                    <div className="border-t px-2 py-2">
                                        <Button
                                            ...
                                            onClick={navigateToSearchResults}
                                        >
                                            {t('common:moreResults', { count: products.length - 5 })}
                                        </Button>
                                    </div>
                                )}
                            </>
